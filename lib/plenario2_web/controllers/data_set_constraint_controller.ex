defmodule Plenario2Web.DataSetConstraintController do
  ...
  def edit(conn, %{"slug" => meta_slug, "id" => cons_id}) do
    ...
    render(conn, "edit.html", cons: cons, changeset: changeset, action: action, disabled: disabled, field_opts: field_opts)
  end
  ...
  def update(conn, %{"slug" => meta_slug, "id" => cons_id, "data_set_constraint" => cons_params}) do
    ...
    case changeset do
      ...
      {:error, changeset} ->
        ...
        |> render("edit.html", cons: cons, changeset: changeset, action: action, disabled: disabled, field_opts: field_opts)
    end
  end
end
