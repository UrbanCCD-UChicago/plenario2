defmodule Plenario2Auth.UserActions do
  ...
  """
  @spec create(name :: String.t, password :: String.t, email :: String.t, organization :: String.t, role :: String.t) :: {:ok, %User{} | :error, Ecto.Changeset.t}
  ...
  """
  @spec update_name(user :: %User{}, new_name :: String.t) :: {:ok, %User{} | :error, Ecto.Changeset.t}
  ...
  """
  @spec update_email_address(user :: %User{}, new_email :: String.t) :: {:ok, %User{} | :error, Ecto.Changeset.t}
  ...
  Options for `opts` param:
    ...
    - org_role
  """
  @spec update_org_info(user :: %User{}, opts :: [{atom, String.t}]) :: {:ok, %User{} | :error, Ecto.Changeset.t}
  ...
  """
  @spec update_password(user :: %User{}, new_password :: String.t) :: {:ok, %User{} | :error, Ecto.Changeset.t}
