defmodule PlenarioEtl.Shapefile do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> PlenarioEtl.Shapefile.load(
  ...
  def load(path, table) do
    host = Application.get_env(:plenario, Plenario.Repo)[:hostname]
    user = Application.get_env(:plenario, Plenario.Repo)[:username]
    password = Application.get_env(:plenario, Plenario.Repo)[:password]
    db = Application.get_env(:plenario, Plenario.Repo)[:database]
